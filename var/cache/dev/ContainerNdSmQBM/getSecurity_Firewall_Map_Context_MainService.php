...
include_once $this->targetDirs[3].'\\src\\Common\\Handler\\UserLogoutSuccessHandler.php';
...
$c = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, new \App\Common\Handler\UserLogoutSuccessHandler(), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'passport_logout'));
