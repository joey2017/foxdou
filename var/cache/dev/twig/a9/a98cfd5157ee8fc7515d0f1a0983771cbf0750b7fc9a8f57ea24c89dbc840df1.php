...
class __TwigTemplate_4e4100ebebc9efa59a731e1ce553e3d9e656735189aab4a4143841be7aa5b6af extends Twig_Template
{
    private $source;
...
<div id=\"foot\">
    ...
    <p>";
        // line 48
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["settings"]) || array_key_exists("settings", $context) ? $context["settings"] : (function () { throw new Twig_Error_Runtime('Variable "settings" does not exist.', 48, $this->source); })()), "system", array()), "beian_info", array()), "html", null, true);
        echo "</p>
</div>
