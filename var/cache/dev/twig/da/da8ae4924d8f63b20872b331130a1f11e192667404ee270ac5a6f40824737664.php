...
class __TwigTemplate_358ce36cacdbdf6677754547f5d638f107748c2bbf9ebd9fb84dc50bba50eecc extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        $context["sf"] = $this->loadTemplate("/Common/simple_form_helpers_for_layui.html.twig", "Admin/UserSubAccountLevel/index.twig", 2);
        // line 3
        $context["title"] = "用户级别";
        // line 5
    ...
    <form id=\"edit_form\">
      ...
      ";
        ...
        if (((isset($context["current_tab"]) || array_key_exists("current_tab", $context) ? $context["current_tab"] : (function () { throw new Twig_Error_Runtime('Variable "current_tab" does not exist.', 29, $this->source); })()) == 0)) {
          ...
          ";
            // line 31
            echo $context["sf"]->macro_select(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 31, $this->source); })()), "platform_id", array()), $this->extensions['App\Common\Twig\AppExtension']->toOptions(twig_constant("App\\Platform::PLATFORMS"), "全部"), array("class" => "form-control"));
            echo "
        </div>
      ";
        } else {
...
//                ,cellMinWidth: 80
        ...
        echo "', {\"id\": data.id, \"default\": 1, \"_token\": \"";
        echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Bridge\Twig\Extension\CsrfRuntime')->getCsrfToken("edit_level"), "html", null, true);
        echo "\"}, function (data) {
                      if (data.status) {
                          location.reload();
