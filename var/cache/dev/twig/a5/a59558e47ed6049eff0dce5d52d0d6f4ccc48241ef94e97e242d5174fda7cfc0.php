...
class __TwigTemplate_74483b0b39308a5b6b5e2e644e8b1ae0de6c0b6eff907c73705d295fc60edd5b extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 1
        $context["sf"] = $this->loadTemplate("/Common/simple_form_helpers.html.twig", "Passport/User/_profile.twig", 1);
        // line 2
        echo "
  <style type=\"text/css\">
  ...
  <div class=\"m-wrapper\">
    ...
    <div class=\"m-single\">
      <ul class=\"info-skin\">
        ...
        // line 26
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 26, $this->source); })()), "avatarUrl", array()), "html", null, true);
...
//      upload_alios_img('#head_img','.user_head_portrait,#head_img',{});
      layui.use(['layer'], function(){
        ...
        echo "',{
                  type:'post'
                  ,data:{nick_name:value,'_csrf_token':'";
        // line 182
      ...
      layui.use(['layer'], function(){
          ...
          function save(this_dom){
              ...
              \$.ajax('{{ path('passport_user_profile_update') }}',{
                  type:'post'
                  ,data:{nick_name:value,'_csrf_token':'{{ csrf_token(\"passport_user_profile_update\") }}'}
                  ,success:function (data) {
                      layer.msg(data.msg);
                      if(!data.status){
                          layer.msg(data.msg);
