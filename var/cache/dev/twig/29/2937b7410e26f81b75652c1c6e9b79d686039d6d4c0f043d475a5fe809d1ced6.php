...
class __TwigTemplate_f396b9c86e8c4f5f8f30b2e067021921e69f48c0126371157076c05f0cda56d3 extends Twig_Template
{
    private $source;
...
{% if not is_granted('ROLE_USER') %}
  ...
  <div class=\"blackMask\" style=\"display: none;\">
    <div class=\"login-alpha\">
      <div class=\"login\">
        <i class=\"icon iconfont icon-guanbi\" onclick=\"close_login()\"></i>
        <form class=\"layui-form dialog-login\" id=\"pintai-login\" action=\"{{ url('passport_login') }}\" method=\"post\">
          <input type=\"hidden\" name=\"_csrf\" value=\"<?=\$request->csrfToken?>\">
          <p class=\"login-title\">登录狐豆</p>
          <div class=\"login-group\">
            <div class=\"login-input-group\">
        ...
        <p class=\"login-arrow\">
          ...
          <span>|</span>
          <a href=\"{{ path('passport_register') }}\" target=\"_blank\">注册帐号</a>
          <span>|</span>
          <a href=\"javascript:void(0);\">意见反馈</a>
        </p>
        <div class=\"login-way\" style=\"display: none;\">
