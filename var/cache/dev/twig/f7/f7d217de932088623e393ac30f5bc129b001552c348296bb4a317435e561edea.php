...
class __TwigTemplate_cbc96980ec1b196451af1ce40b83d10ece69700c29e8fd803ab083092677a20c extends Twig_Template
{
    private $source;
...
<div class=\"main-box\">
    <div class=\"screen-item\">
        ...
        <div class=\"h-form-input\">
            ...
            <input type=\"hidden\" name=\"_csrf_token\" value=\"{{ csrf_token('admin_user_details_open_platform_apps') }}\">
        </form>
    </div>
    <!--    <div class=\"h-button-group\">-->
    <!--        <button class=\"btn btn-green\">查看统计</button>-->
