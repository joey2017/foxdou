...
class __TwigTemplate_5b2e5524fa1f6f0c6191fb916e91c54f3bd90b9543c477badbef903333db9ecc extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        $context["sf"] = $this->loadTemplate("/Common/simple_form_helpers.html.twig", "Admin/User/pass_management.twig", 2);
        // line 1
            ...
            <div class=\"layui-form layui-form-pane layui-card-header layuiadmin-card-header-auto\">
                <form class=\"layui-form-item\" id=\"form\">
                    ...
                    <div class=\"layui-inline\">
                        ";
        // line 14
        echo $context["sf"]->macro_select_raw("type", $this->extensions['App\Common\Twig\AppExtension']->arrayToOptions(twig_constant("App\\Common\\Model\\User\\User::TYPES"), "注册类型"), array("class" => "layui-input"));
        echo "
                    </div>
                    <div class=\"layui-inline\">
                        ";
        // line 17
        echo $context["sf"]->macro_select_raw("status", $this->extensions['App\Common\Twig\AppExtension']->arrayToOptions(twig_constant("App\\Common\\Model\\User\\User::STATUSES"), "账户状态"), array("class" => "layui-input"));
        echo "
                    </div>
                    <div class=\"layui-inline\">
                        ";
        // line 20
        echo $context["sf"]->macro_select_raw("is_entry_identity_info", $this->extensions['App\Common\Twig\AppExtension']->arrayToOptions(twig_constant("App\\Common\\Model\\User\\User::IDENTITY_STATUS"), "身份信息"), array("class" => "layui-input"));
        echo "
                    </div>
                    <div class=\"layui-inline\">
                        ";
        // line 23
        echo $context["sf"]->macro_select_raw("real_name_status", $this->extensions['App\Common\Twig\AppExtension']->arrayToOptions(twig_constant("App\\Common\\Model\\User\\RealNameAuthenticationInfo::STATUSES"), "实名认证"), array("class" => "layui-input"));
        echo "
                    </div>
                    <div class=\"layui-inline\">
                        ";
        // line 26
        echo $context["sf"]->macro_select_raw("is_open_platform", $this->extensions['App\Common\Twig\AppExtension']->arrayToOptions(twig_constant("App\\Common\\Model\\User\\User::OPENPLATFORM_STATUS"), "开放平台账户开通状态"), array("class" => "layui-input"));
        echo "
                    </div>
                    <div class=\"layui-inline\">
                        ";
        // line 29
        echo $context["sf"]->macro_select_raw("is_agent_platform", $this->extensions['App\Common\Twig\AppExtension']->arrayToOptions(twig_constant("App\\Common\\Model\\User\\User::AGENTPLATFORM_STATUS"), "代理商平台账户开通状态"), array("class" => "layui-input"));
        echo "
                    </div>
                    <div class=\"layui-inline\">
                        ";
        // line 32
        echo $context["sf"]->macro_select_raw("is_supplier_platform", $this->extensions['App\Common\Twig\AppExtension']->arrayToOptions(twig_constant("App\\Common\\Model\\User\\User::SUPPLIERPLATFORM_STATUS"), "供应商平台账户开通状态"), array("class" => "layui-input"));
        echo "
                    </div>
                    <div class=\"layui-inline\">
