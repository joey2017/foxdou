...
class __TwigTemplate_e67a8f8acc2d94ecce0201c178ba19d5a079cb45c84b98466877d92d1f1299a6 extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        $context["sf"] = $this->loadTemplate("/Common/simple_form_helpers.html.twig", "Admin/User/levels.twig", 2);
        // line 3
        echo "
";
        // line 4
...
";
  ...
  <div class=\"add_level_dialog\" style=\"display: none; padding: 20px 20px 0px 20px;\">
    ...
    ";
        ...
        ";
            // line 103
            echo $context["sf"]->macro_select_raw("select_platform_id", $this->extensions['App\Common\Twig\AppExtension']->arrayToOptions(twig_constant("App\\Platform::PLATFORMS"), "全部"), array("class" => "form-control"));
            echo "
      </div>
    ";
        } else {
        ...
        <div class=\"ibox-title\">
          ...
          <div class=\"ibox-content\">
              ...
              <div class=\"seach\">
                  ...
                  <input type=\"hidden\" name=\"_csrf_token\" value=\"{{ csrf_token('admin_users_ajax_levels') }}\">
                  <div class=\"row\">
                      <div class=\"col-sm-2\">
                          <div class=\"input-group m-b\"><span class=\"input-group-addon\">ID</span>
                              <input name=\"id\" value=\"\" placeholder=\"ID\" class=\"form-control\"/>
                  ...
                  layer.open({
                      ...
                      yes: function(index){
                          \$.post('{{ path('admin_users_level_edit') }}',{
                              ...
                              name:\$('#level_name').val(),
                              info:\$('#level_info').val(),
                              _csrf_token:'{{ csrf_token('admin_users_level_edit') }}'
                          },function(data){
                              layer.close(index);
                              if(!data.status){
                                  layer.alert(data.msg);
          ...
          layer.open({
              ...
              yes: function(index,layerindex){
                  ...
                  \$.post(addUrl,{
                      ...
                      platform_id:platform_id,
                      synchro_level:synchro_level,
                      _csrf_token:'{{ csrf_token('admin_users_level_add') }}'
                  },function(data){
                      if(!data.status){
                          layer.alert(data.msg);
                          return;
