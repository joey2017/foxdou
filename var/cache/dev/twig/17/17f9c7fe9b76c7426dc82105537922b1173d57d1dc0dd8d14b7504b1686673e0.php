...
class __TwigTemplate_12e2e24fbb8dbb22de710e025540774a4f20c7cbd698aea2a89f8de36e506df5 extends Twig_Template
{
    private $source;
...
<script>
    ...
    table.on('tool(order-table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter=\"对应的值\"
        ...
        if(layEvent === 'mark_succeed'){ //置成功
            confirmAction('";
        // line 102
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_orders_set_success");
        ...
        if(layEvent === 'mark_failed'){ //置失败
            confirmAction('";
        // line 106
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_orders_set_failure");
    ...
    {
        return array (  271 => 211,  259 => 202,  235 => 181,  198 => 147,  183 => 135,  175 => 130,  148 => 106,  141 => 102,  68 => 32,  63 => 30,  57 => 27,  29 => 1,);
    }
