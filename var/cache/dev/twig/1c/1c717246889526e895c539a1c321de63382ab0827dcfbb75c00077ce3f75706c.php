...
class __TwigTemplate_01ce044891aad9c3aa8da8bbace0dde4daaafd4e49c7d4e2c6836785f0e82d29 extends Twig_Template
{
    private $source;
...
//      upload_alios_img('#head_img','.user_head_portrait,#head_img',{});
      ...
      \$(function(){
          ...
          function save(this_dom){
              ...
              \$.ajax('/reseller/dashboard/user-info/update',{
                  type:'post'
                  ,data:{nick_name:value,'_csrf_token':'{{ csrf_token(\"update_user_info\") }}'}
                  ,success:function (data) {
                      layer.msg(data.msg);
                      if(!data.status){
                          return false;
          ...
          \$('#save-contact').click(function () {
              ...
              \$.ajax('/reseller/dashboard/user-info/edit-contact-and-shop-info', {
                  ...
                  ,data:{contact_name:\$('#contact_name').val()
                      ...
                      ,shop_name:\$('#shop_name').val()
                      ,shop_address:\$('#shop_address').val()
                      ,'_csrf_token':'{{ csrf_token(\"update_user_info\") }}'
                  }
                  ,success: function (data) {
                      layer.msg(data.msg);
                  }
