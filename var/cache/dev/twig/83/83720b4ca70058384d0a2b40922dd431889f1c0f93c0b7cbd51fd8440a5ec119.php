...
/* Common/Common/layout.twig */
class __TwigTemplate_897c6e2ab0db8e293c5fac4f99aae9fa97c905636f0f17928930f0f2db9bc068 extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "Common/Common/layout.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "Common/Common/layout.twig"));
...
";
  ...
  <div class=\"m-head-nav f-fs-16\">
    ";
        // line 71
        $this->loadTemplate("Open/Common/topNav.twig", "Common/Common/layout.twig", 71)->display($context);
        // line 72
        echo "  </div>
</div>
<!-- 主体 -->
<div class=\"g-main\">
  ...
  <div class=\"m-left\">
    ";
        // line 78
        $this->loadTemplate("Open/Common/left_nav_head.twig", "Common/Common/layout.twig", 78)->display($context);
        // line 79
        echo "  </div>
  <!-- /侧栏导航 -->
  <!-- 右侧内容区域 -->
...
//        });
    ...
    function setread(status,id) {
        \$.ajax('/read-notice',{
            type:'post'
            ,data:{id:id,status:status,'_csrf_token':_CSRF}
            ,success:function () {
                if(data.status){
                    return true;
                }
    ...
    \$('#lock-screen').click(function () {
        \$.ajax('/lock-screen/index',{
            type:'post'
            ,data:{'_csrf_token':_CSRF,url:location.href}
    ...
    function change_skin(skin) {
        ...
        \$.ajax('/backend/default/change-skin',{
            type:'post'
            ,data:{skin:skin,'_csrf_token':_CSRF}
            ,success:function (data) {
                layer.msg(data.msg);
                if(!data.status){
                    return false;
...
";
    ...
    {
        return "Common/Common/layout.twig";
    }
...
", "Common/Common/layout.twig", "D:\\phpStudy\\WWW\\foxdou\\templates\\Common\\Common\\layout.twig");
    }
}
