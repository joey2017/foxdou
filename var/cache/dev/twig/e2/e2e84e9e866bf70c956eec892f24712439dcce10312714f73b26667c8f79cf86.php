...
class __TwigTemplate_5f05cf568848cb1119991b377720b9d2be49489298f732f9a49cc32bf1d68fd7 extends Twig_Template
{
    private $source;
    ...
    <div class=\"pay-item g-bdc\">
      ...
      <div class=\"pay-item-content\">
        ...
        echo "\" type=\"hidden\">
                <input name=\"platform_id\" value=\"";
        // line 97
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["sub_account"]) || array_key_exists("sub_account", $context) ? $context["sub_account"] : (function () { throw new Twig_Error_Runtime('Variable "sub_account" does not exist.', 97, $this->source); })()), "platformId", array()), "html", null, true);
        echo "\" type=\"hidden\">
                <input name=\"scene_id\" value=\"";
        // line 98
        echo twig_escape_filter($this->env, (isset($context["scene_id"]) || array_key_exists("scene_id", $context) ? $context["scene_id"] : (function () { throw new Twig_Error_Runtime('Variable "scene_id" does not exist.', 98, $this->source); })()), "html", null, true);
        echo "\" type=\"hidden\">
...
<script type=\"text/javascript\">
    ...
    layui.use(['layer'], function () {
        ...
        bind_input_event('amount', function () {
            ...
            ";
        // line 209
        if ( !twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 209, $this->source); })()), "debug", array())) {
            // line 210
...
";
    ...
    {
        return array (  316 => 238,  290 => 214,  284 => 210,  282 => 209,  219 => 149,  165 => 98,  161 => 97,  157 => 96,  122 => 64,  118 => 63,  114 => 62,  94 => 45,  80 => 35,  78 => 34,  55 => 14,  44 => 6,  38 => 5,  33 => 3,  29 => 1,);
    }
        ...
        <div class=\"wrapper\">
          ...
          <div class=\"wap-main\">
              ...
              <div class=\"alipay-row g-bdc\">
                ...
                <div class=\"alipay-right-row\">
                  ...
                  <div class=\"alipay-text\">
                    ...
                    <div style=\"margin-top: 20px;\">
                      <input name=\"_csrf_token\" value=\"{{ csrf_token('common_finance_balance_add_balance_via_alipay_transfer') }}\" type=\"hidden\">
            ...
            <div key=\"c\">
              ...
              <div style=\"margin-top: 20px;\">
                <input name=\"_csrf_token\" value=\"{{ csrf_token('common_finance_balance_add_balance_via_alipay_online_payment') }}\" type=\"hidden\">
                <input name=\"platform_id\" value=\"{{ sub_account.platformId }}\" type=\"hidden\">
                <input name=\"scene_id\" value=\"{{ scene_id }}\" type=\"hidden\">
                <button class=\"layui-btn f-fnsna\" lay-submit=\"\" lay-filter=\"demo1\" id=\"pc-alipay-next\">下一步</button>
              </div>
