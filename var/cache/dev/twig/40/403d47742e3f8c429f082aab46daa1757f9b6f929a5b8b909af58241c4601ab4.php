...
/* Admin/User/add.twig */
class __TwigTemplate_e20a577f0648e4549e41f7ca697dbcdf33d034e2b236024c1827d963b80f4cd8 extends Twig_Template
{
    private $source;
...
<div class=\"wrapper wrapper-content animated fadeInRight\">
    <div class=\"text-center\"><h3>新增用户</h3></div>
    <form action=\"\" method=\"post\" class=\"form form-horizontal m-t\">
        <input type=\"hidden\" name=\"_csrf_token\" value=\"{{ csrf_token('admin_users_add') }}\">
        <div class=\"text-center m-b\">
            {% for k,t in type %}
