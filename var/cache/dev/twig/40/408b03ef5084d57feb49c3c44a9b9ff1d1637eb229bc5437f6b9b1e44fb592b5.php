...
class __TwigTemplate_c04e3fb8248c19937475c53bf787c38afd5a5d2317800b3c93782887185d3845 extends Twig_Template
{
    private $source;
...
<div class=\"sisi-box-bg\">
  ...
  <div class=\"sisi-foot\">
    ...
    <p>";
        // line 182
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["settings"]) || array_key_exists("settings", $context) ? $context["settings"] : (function () { throw new Twig_Error_Runtime('Variable "settings" does not exist.', 182, $this->source); })()), "system", array()), "beian_info", array()), "html", null, true);
        echo "</p>
  </div>
  <!-- /版权 -->
</div>
...
";
    ...
    {
        return array (  275 => 197,  273 => 196,  271 => 195,  269 => 194,  267 => 193,  264 => 191,  262 => 190,  252 => 182,  247 => 180,  225 => 161,  213 => 152,  192 => 134,  153 => 98,  113 => 60,  108 => 58,  103 => 57,  98 => 55,  91 => 54,  85 => 52,  82 => 51,  80 => 50,  29 => 1,);
    }
...
<div class=\"sisi-box-bg\">
  ...
  <div class=\"sisi-top\">
    ...
    <div class=\"sisi-top-right\">
      {% if is_logged_in() %}
        ...
        <a href=\"{{ url('passport_logout') }}\">退出登录</a>
      {% else %}
        <a href=\"{{ url('passport_login') }}\">登录</a>
        <a href=\"{{ path('passport_register') }}\">注册</a>
      {% endif %}
      <a href=\"#\">更多产品</a>
    </div>
  </div>
  ...
  <div class=\"sisi-main\">
    ...
    <div class=\"sisi-contents\" style=\"\">
      ...
      <div id=\"content-1\" class=\"s-content clearfloat\">
        <div class=\"module-1\" style=\"\">
          <a href=\"{{ path('passport_home_index') }}\">
            <div class=\"module\">
              <i class=\"iconfont\">&#xe655;</i>
              <h2>狐豆通行证</h2>
              <span>Passport</span>
        ...
        <div class=\"module-5\">
          <a href=\"{{ path('reseller_home') }}\" target=\"_blank\">
            <div class=\"module\">
              <i class=\"iconfont\">&#xe625;</i>
              <h2>狐豆代理</h2>
              <span>Agent</span>
...
{#<div style='font-size: 40pt;text-align: center;'>#}
  ...
  {#<a href=\"{{ url('passport_login') }}\">登录</a><br/>#}
