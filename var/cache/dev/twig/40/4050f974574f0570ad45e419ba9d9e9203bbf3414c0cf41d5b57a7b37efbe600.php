...
/* Admin/UserDetail/SupplierPlatform/common_tabs.twig */
class __TwigTemplate_b348d01ecbc55959c5fd35a0b5ba206195bf314fd444cc2d9fe16712aacc6e90 extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "Admin/UserDetail/SupplierPlatform/common_tabs.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "Admin/UserDetail/SupplierPlatform/common_tabs.twig"));
    ...
    <ul class=\"h-tab\">
        ...
        <a href=\"";
        // line 4
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_user_details_supplier_platform_finance", array("id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new Twig_Error_Runtime('Variable "id" does not exist.', 4, $this->source); })()))), "html", null, true);
        echo "\">账户概览</a></li>
        <li class=\"";
        // line 5
        ...
        <a href=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_user_details_supplier_platform_trade_logs", array("id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new Twig_Error_Runtime('Variable "id" does not exist.', 6, $this->source); })()))), "html", null, true);
        echo "\">交易记录</a></li>
        <li class=\"";
        // line 7
        ...
        <a href=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_user_details_supplier_platform_finance_detail", array("id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new Twig_Error_Runtime('Variable "id" does not exist.', 8, $this->source); })()))), "html", null, true);
        echo "\">资金明细</a></li>
        <li class=\"";
        // line 9
        ...
        <a href=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_user_details_supplier_platform_charge_logs", array("id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new Twig_Error_Runtime('Variable "id" does not exist.', 10, $this->source); })()))), "html", null, true);
        echo "\">充值记录</a></li>
    </ul>
</div>";
    ...
    {
        return "Admin/UserDetail/SupplierPlatform/common_tabs.twig";
    }
    ...
    <ul class=\"h-tab\">
        ...
        <a href=\"{{ path('admin_user_details_supplier_platform_finance',{id:id}) }}\">账户概览</a></li>
        <li class=\"{% if app.request.get('_route') == 'trade-logs' %}'tab-this'{% endif %}\">
        <a href=\"{{ path('admin_user_details_supplier_platform_trade_logs',{id:id}) }}\">交易记录</a></li>
        <li class=\"{% if app.request.get('_route') == 'finance-detail' %}'tab-this'{% endif %}\">
        <a href=\"{{ path('admin_user_details_supplier_platform_finance_detail',{id:id}) }}\">资金明细</a></li>
        <li class=\"{% if app.request.get('_route') == 'charge-logs' %}'tab-this'{% endif %}\">
        <a href=\"{{ path('admin_user_details_supplier_platform_charge_logs',{id:id}) }}\">充值记录</a></li>
    </ul>
</div>", "Admin/UserDetail/SupplierPlatform/common_tabs.twig", "D:\\phpStudy\\WWW\\foxdou\\templates\\Admin\\UserDetail\\SupplierPlatform\\common_tabs.twig");
    }
}
