...
class __TwigTemplate_233c31cf6a1a97ef82915bdc9ad635b7cc57069cff3d5c54e0f4ae5f29a55597 extends Twig_Template
{
    private $source;
...
<div class=\"page-right\">
  ...
  <div class=\"m-container\" style=\"height: 200px;\">
    <div class=\"layui-tab layui-tab-brief\" style=\"margin: 0 0 5px 0;\">
      <h2 class=\"container-title\">最新公告<a href=\"";
        // line 127
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("reseller_dashboard_announcements");
        echo "\">更多&gt;&gt;</a></h2>
      <div class=\"layui-tab-content\">
        <div class=\"layui-tab-item layui-show\">
          ";
        // line 130
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Extension\HttpKernelRuntime')->renderFragment(Symfony\Bridge\Twig\Extension\HttpKernelExtension::controller("App\\Common\\Controller\\ArticleController::indexAction", array("portal_id" => twig_constant("App\\Platform::RESELLER"), "cate_id" => 6, "limit" => 5, "format" => "list")));
        echo "
        </div>
      </div>
    </div>
...
<script type=\"text/javascript\">
    ...
    \$(document).ready(function () {
        \$.ajax('/user-login-ip-query',{async:true,type:'POST',dataType:'json',data:{'_token':'user-login-ip-query:";
        // line 200
...
";
    ...
    {
        return array (  287 => 200,  214 => 130,  208 => 127,  157 => 78,  147 => 74,  143 => 73,  139 => 72,  136 => 71,  132 => 70,  107 => 48,  103 => 47,  84 => 31,  78 => 28,  59 => 11,  56 => 5,  47 => 4,  37 => 1,  35 => 2,  15 => 1,);
    }
...
<div class=\"page-right\">
  ...
  <div class=\"m-container\" style=\"height: 200px;\">
    <div class=\"layui-tab layui-tab-brief\" style=\"margin: 0 0 5px 0;\">
      ...
      <div class=\"layui-tab-content\">
        <div class=\"layui-tab-item layui-show\">
          {{ render(controller('App\\\\Common\\\\Controller\\\\ArticleController::indexAction', { 'portal_id': constant('App\\\\Platform::RESELLER'), 'cate_id': 6, 'limit': 5, 'format': 'list' } )) }}
        </div>
      </div>
    </div>
  </div>
