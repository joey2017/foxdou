...
class __TwigTemplate_9bf0b8f013b1c6d517b796052e295c2adddb0c2435c5bfb65159681bbe551409 extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 1
        $this->loadTemplate("/Common/User/register__header.twig", "Passport/Register/registerIndividual.twig", 1)->display($context);
        // line 2
        echo "
<div id=\"agreements\" style=\"display: none; padding: 20px;\">
  ";
        // line 4
        $this->loadTemplate("/Common/User/register__agreements.twig", "Passport/Register/registerIndividual.twig", 4)->display($context);
        // line 5
        echo "</div>
    ...
    <form class=\"layui-form\" style=\"margin-top: 10px;\">
      ...
      <div class=\"register-step-1\" style=\"display: block;\">
        ...
        <div class=\"layui-form-item\">
          ...
          <div class=\"layui-input-inline\">
            <input type=\"password\" name=\"password\" placeholder=\"请输入登录密码\" autocomplete=\"off\" class=\"layui-input\" style=\"width: 250px;\" required>
          </div>
          <div class=\"layui-form-mid layui-word-aux\"></div>
        </div>
        ";
        ...
        ";
        // line 73
        if ($this->extensions['App\Common\Twig\AppExtension']->getParams("user.identity_verify_required")) {
            // line 74
            echo "        <div class=\"layui-form-item\">
          <label class=\"layui-form-label\">真实姓名</label>
          <div class=\"layui-input-inline\">
            <input type=\"text\" name=\"real_name\" placeholder=\"真实姓名\" autocomplete=\"off\" class=\"layui-input\" style=\"width: 250px;\" required value=\"晨晨\">
          </div>
          <div class=\"layui-form-mid layui-word-aux\"></div>
        </div>
        <div class=\"layui-form-item\">
          ...
          <div class=\"layui-input-inline\">
            <input type=\"text\" name=\"id_num\" placeholder=\"请输入您的身份证号\" autocomplete=\"off\" class=\"layui-input\" style=\"width: 250px;\" required lay-verify=\"id_num\" value=\"350103198705202325\">
          </div>
          <div class=\"layui-form-mid layui-word-aux\"></div>
        </div>
        ";
        ...
        <div style=\"padding-left: 110px; margin-top: 10px;\">
          <input id=\"_csrf_token\" name=\"_csrf_token\" value=\"";
        // line 91
...
";
        // line 175
        $this->loadTemplate("/Common/User/register__footer.twig", "Passport/Register/registerIndividual.twig", 175)->display($context);
    ...
    {
        return array (  243 => 175,  227 => 162,  217 => 155,  186 => 127,  161 => 105,  144 => 91,  140 => 89,  123 => 74,  121 => 73,  118 => 72,  116 => 71,  114 => 70,  112 => 69,  110 => 68,  108 => 67,  106 => 66,  104 => 65,  75 => 38,  70 => 36,  37 => 5,  35 => 4,  31 => 2,  29 => 1,);
    }
  ...
  <div class=\"register-content\">
    <form class=\"layui-form\" style=\"margin-top: 10px;\">
      ...
      <div class=\"register-step-1\" style=\"display: block;\">
        ...
        {% if params('user.identity_verify_required') %}
        <div class=\"layui-form-item\">
          <label class=\"layui-form-label\">真实姓名</label>
          <div class=\"layui-input-inline\">
            <input type=\"text\" name=\"real_name\" placeholder=\"真实姓名\" autocomplete=\"off\" class=\"layui-input\" style=\"width: 250px;\" required value=\"晨晨\">
        ...
        <div style=\"padding-left: 110px; margin-top: 10px;\">
          <input id=\"_csrf_token\" name=\"_csrf_token\" value=\"{{ csrf_token('user_register') }}\" type=\"hidden\" >
          <input id=\"agree\" name=\"agree\" value=\"yes\" title=\"我已阅读并同意相关服务条款和隐私政策\" type=\"checkbox\" class=\"sisi-checkbox\" >
          <span>我已阅读并同意相关<a href=\"javascript:void (0);\" style=\"color: #00a0e9\" onclick=\"agreement();\">《服务条款和隐私政策》</a></span>
        </div>
        <div style=\"padding-left: 110px; margin-top: 40px;\">
    ...
    <div class=\"register-step-2\" style=\"display: none; text-align: center;\">
      <p id=\"info-box\"></p>
      <p style=\"text-align: center;margin-top: 50px;\">
        <a href=\"{{ path('login') }}\" class=\"layui-btn\" id=\"btn-next-action\">马上登录</a>
      </p>
    </div>
    <!-- /注册成功 -->
  </div>
...
<script>
    ...
    layui.use('form', function () {
        ...
        form.verify({
            mobile: function (value) {
                ...
                err = check_reg_number('{{ path('passport_user_check_reg_mobile') }}', 'mobile', value, '手机号已被注册');
                if (err) {
                    return err;
                }
            },
    ...
    \$('form').submit(function () {
        ...
        var form_data = \$(this).serializeArray();
        \$.post('{{ path('passport_user_register_individual') }}', form_data, function (data) {
            if (data.status) {
                \$('.register-step-1').css('display', 'none');
                \$('.register-step-2').css('display', 'block');
                \$('#info-box').html(data.content);
