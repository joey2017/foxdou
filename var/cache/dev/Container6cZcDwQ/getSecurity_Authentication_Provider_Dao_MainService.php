...
include_once $this->targetDirs[3].'\\src\\Common\\Service\\UserChecker.php';
include_once $this->targetDirs[3].'\\vendor\\symfony\\security-core\\User\\UserProviderInterface.php';
include_once $this->targetDirs[3].'\\src\\Common\\Service\\UserProvider.php';

return $this->privates['security.authentication.provider.dao.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(($this->privates['App\Common\Service\UserProvider'] ?? ($this->privates['App\Common\Service\UserProvider'] = new \App\Common\Service\UserProvider())), new \App\Common\Service\UserChecker(), 'main', ($this->privates['security.encoder_factory.generic'] ?? $this->load('getSecurity_EncoderFactory_GenericService.php')), true);
