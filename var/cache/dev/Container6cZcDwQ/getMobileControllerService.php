...
// Returns the public 'App\Admin\Controller\ProductManagement\MobileController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\Controller\\ProductManagement\\MobileController.php';

$this->services['App\Admin\Controller\ProductManagement\MobileController'] = $instance = new \App\Admin\Controller\ProductManagement\MobileController(($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()));
...
$instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    ...
    'App\\Admin\\Controller\\ProductManagement\\MobileController::productManager' => array('privates', 'App\\Admin\\Service\\ProductMobileManager', 'getProductMobileManagerService.php', true),
...
)))->withContext('App\\Admin\\Controller\\ProductManagement\\MobileController', $this));
