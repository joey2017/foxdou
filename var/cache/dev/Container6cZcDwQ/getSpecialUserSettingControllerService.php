...
// Returns the public 'App\Admin\Controller\ProductManagement\SpecialUserSettingController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\Controller\\ProductManagement\\SpecialUserSettingController.php';

$this->services['App\Admin\Controller\ProductManagement\SpecialUserSettingController'] = $instance = new \App\Admin\Controller\ProductManagement\SpecialUserSettingController(($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()));
...
$instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    ...
    'App\\Admin\\Controller\\ProductManagement\\SpecialUserSettingController::productManager' => array('privates', 'App\\Admin\\Service\\ProductMobileManager', 'getProductMobileManagerService.php', true),
...
)))->withContext('App\\Admin\\Controller\\ProductManagement\\SpecialUserSettingController', $this));
