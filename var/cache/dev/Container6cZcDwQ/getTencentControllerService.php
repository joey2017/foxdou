...
// Returns the public 'App\Admin\Controller\ProductManagement\TencentController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\Controller\\ProductManagement\\TencentController.php';

$this->services['App\Admin\Controller\ProductManagement\TencentController'] = $instance = new \App\Admin\Controller\ProductManagement\TencentController(($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()));
...
$instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    ...
    'App\\Admin\\Controller\\ProductManagement\\TencentController::productManager' => array('privates', 'App\\Admin\\Service\\ProductTencentManager', 'getProductTencentManagerService.php', true),
...
)))->withContext('App\\Admin\\Controller\\ProductManagement\\TencentController', $this));
