...
use App\OpenApi\Form\Recharge\Tencent\QueryProductForm;
use App\OpenApi\Service\RechargeProductService;
use App\ProductConstants;
use Symfony\Contracts\Service\ServiceSubscriberTrait;

class TencentQueryProductHandler extends AbstractHandler {
    ...
    public function handle(ApiContext $context) {
        ...
        $products = $this->rechargeProductService()->findProducts($context->account, $numberInfo, ProductConstants::PRODUCT_TYPE_TENCENT, (int)$form->amount, (int)$form->speed, 0, 100);
