 ...
 * @property int|null $cate_id  default: (NULL), max length: 1, raw type: tinyint
 ...
 * @property int $strategy_type  default: (1), max length: 1, raw type: tinyint
 ...
 * @property string|null $isp_name  default: (NULL), max length: 20, raw type: varchar
 * @property int $if_mvno  default: (0), max length: 1, raw type: tinyint
 ...
 */
class product_mobile_copy extends \App\Common\Model\BaseModel {
    static $table_name  = 'yzb_product_mobile_copy';
