 ...
 * @property int|null $publish_only  default: (NULL), max length: 4, raw type: tinyint
 */
class site_public_article extends \App\Common\Model\BaseModel {
    static $table_name  = 'yzb_site_public_article';
