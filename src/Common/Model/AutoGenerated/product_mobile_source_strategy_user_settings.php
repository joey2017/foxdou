 ...
 */
class product_mobile_source_strategy_user_settings extends \App\Common\Model\BaseModel {
    static $table_name  = 'yzb_product_mobile_source_strategy_user_settings';
