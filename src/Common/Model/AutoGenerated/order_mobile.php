 ...
 * @property int|null $mvno  default: (NULL), max length: 11, raw type: int
 ...
 * @property float|null $source_mianzi  default: (NULL), max length: 10, raw type: decimal
 ...
 * @property float $num  default: (0), max length: 11, raw type: decimal
 ...
 * @property int $need_notify  default: (0), max length: 1, raw type: tinyint
 ...
 */
class order_mobile extends \App\Common\Model\BaseModel {
    static $table_name  = 'yzb_order_mobile';
