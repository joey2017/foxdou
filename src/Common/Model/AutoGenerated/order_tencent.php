 ...
 * @property string $on  default: (NULL), max length: 20, raw type: varchar
 ...
 * @property int $rechage_yes_no  default: (1), max length: 1, raw type: tinyint
 ...
 * @property string|null $user_info  default: (), max length: 255, raw type: varchar
 * @property string|null $admin_info  default: (NULL), max length: 255, raw type: varchar
 * @property string $recharge_ip  default: (NULL), max length: 255, raw type: varchar
 ...
 */
class order_tencent extends \App\Common\Model\BaseModel {
    static $table_name  = 'yzb_order_tencent';
