 ...
 * @property string|null $product_type  default: (NULL), max length: 16, raw type: varchar
 * @property int|null $category_id  default: (NULL), max length: 1, raw type: int
 ...
 */
class product_tencent extends \App\Common\Model\BaseModel {
    static $table_name  = 'yzb_product_tencent';
