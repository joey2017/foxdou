 ...
 * @property string|null $business_name  default: (NULL), max length: 255, raw type: varchar
 ...
 * @property string|null $business_license_no  default: (NULL), max length: 255, raw type: varchar
 ...
 * @property string|null $status  default: (PENDING), max length: 20, raw type: char
 * @property int|null $status_info  default: (0), max length: 1, raw type: tinyint
 * @property int|null $status_positive_photo  default: (0), max length: 1, raw type: tinyint
 * @property int|null $status_negative_photo  default: (0), max length: 1, raw type: tinyint
 * @property int|null $status_business_license_photo  default: (0), max length: 1, raw type: tinyint
 ...
 * @property int $certification_level  default: (0), max length: 1, raw type: tinyint
 * @property string $review_status  default: (PENDING), max length: 20, raw type: varchar
 * @property string $note  default: (), max length: 255, raw type: varchar
 */
class users_real_name_authentication_info extends \App\Common\Model\BaseModel {
